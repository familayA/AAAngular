import {
  AutofillMonitor
} from "./chunk-LO62SZHL.js";
import {
  FormsModule,
  NgControl
} from "./chunk-N3AD6SEA.js";
import {
  ContentObserver
} from "./chunk-G5DC4RTK.js";
import {
...
var MdbAbstractFormControl = class _MdbAbstractFormControl {
  ...
  static ɵfac = function MdbAbstractFormControl_Factory(t) {
    return new (t || _MdbAbstractFormControl)();
  };
...
var MdbLabelDirective = class _MdbLabelDirective {
  ...
  static ɵfac = function MdbLabelDirective_Factory(t) {
    return new (t || _MdbLabelDirective)();
  };
  static ɵdir = ɵɵdefineDirective({
...
var MdbFormControlComponent = class _MdbFormControlComponent {
  ...
  static ɵfac = function MdbFormControlComponent_Factory(t) {
    return new (t || _MdbFormControlComponent)(ɵɵdirectiveInject(Renderer2), ɵɵdirectiveInject(ContentObserver), ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(NgZone));
  };
  static ɵcmp = ɵɵdefineComponent({
    ...
    template: function MdbFormControlComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        ɵɵelement(2, "div", 1, 2)(4, "div", 3, 4)(6, "div", 5);
        ɵɵelementEnd();
      }
    },
    encapsulation: 2,
...
var MdbInputDirective = class _MdbInputDirective {
  ...
  static ɵfac = function MdbInputDirective_Factory(t) {
    return new (t || _MdbInputDirective)(ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(Renderer2), ɵɵdirectiveInject(NgControl, 10), ɵɵdirectiveInject(AutofillMonitor));
  };
  static ɵdir = ɵɵdefineDirective({
